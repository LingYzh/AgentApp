...
- Markdown 保留 CommonMark；当前流式优化初版采用 32–120ms 自适应解析节奏和展示层文本追赶，尚待性能与体验验收。首次缓冲及断流后重新缓冲方案尚未实现，见 `.Codex/HANDOFF.md`。公式与 Mermaid 使用内置离线资源，WebView 禁止网络与本地文件访问，普通正文继续原生渲染。
